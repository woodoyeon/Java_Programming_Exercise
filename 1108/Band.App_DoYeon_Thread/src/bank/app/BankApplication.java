...
import bank.member.MemberThread;
...
public class BankApplication {
    ...
    private static void updateMemberEmail() {
        ...
        // 스레드 생성 및 시작
        MemberThread memberThread = new MemberThread("EmailUpdateThread", memberService, memberId, email);
        memberThread.start();  // 이메일 수정 작업을 스레드로 처리
        try {
            memberThread.join();   // 스레드 작업이 끝날 때까지 대기
